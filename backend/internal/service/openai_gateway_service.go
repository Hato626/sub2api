...
const (
	...
	// 0.160.0 是当前已验证可访问 GPT-5.6 Terra/Luna 的 Codex 客户端版本；
	// 继续使用 0.125.0 会让 /codex/models 漏掉新版模型，且带 Version 头时上游会要求升级。
	codexCLIUserAgent = "codex_cli_rs/0.160.0 (Ubuntu 22.4.0; x86_64) xterm-256color"
