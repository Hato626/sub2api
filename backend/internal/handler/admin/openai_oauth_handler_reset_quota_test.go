...
func (s *openAIQuotaWorkflowStub) QueryReferralStatus(context.Context, int64) (*service.OpenAIReferralStatus, error) {
	return nil, nil
}

func (s *openAIQuotaWorkflowStub) SendReferralInvite(context.Context, int64, service.OpenAIReferralInviteInput) (*service.OpenAIReferralInviteResult, error) {
	return nil, nil
}
