export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportWarning: '导入将创建新账号与代理，并默认绑定对应平台分组；请确认已有数据不会冲突。',
      dataImportSourceFile: '文件导入',
      dataImportSourceText: '粘贴 JSON',
      dataImportFile: '数据文件',
      dataImportText: 'JSON 文本',
      dataImportTextPlaceholder: '将导出的账号 JSON 粘贴到这里...',
      dataImportTextHint: '支持直接粘贴从剪贴板复制的完整导出 JSON，格式与文件导入一致。',
      dataImportTextRequired: '请粘贴要导入的 JSON 数据',
      dataImportPasteFromClipboard: '从剪贴板粘贴',
      dataImportClipboardReadFailed: '无法读取剪贴板，请手动粘贴',
      ...
      openaiQuotaReset: {
        ...
        inviteTooltipLoad: '发送 Codex earned reset 邀请',
        inviteTooltipReady: '发送邀请；选择账号池目标时会尝试自动兑换',
        inviteTooltipWithCount: '剩余邀请次数 {count}',
        inviteTitle: 'Codex earned reset 邀请',
        inviteModePool: '账号池',
        inviteModeEmail: '邮箱',
        targetAccount: '接收账号',
        selectTarget: '选择接收账号',
        ...
        sendInvite: '发送邀请',
        inviteSuccess: '邀请已发送至 {emails}',
        autoRedeemVerified: '自动兑换已验证，目标账号重置次数已增加',
        autoRedeemAttempted: '已尝试自动兑换：{reason}',
        autoRedeemFailed: '自动兑换失败：{reason}',
        autoRedeemSkipped: '未自动兑换：{reason}'
      },
      tier: {
        free: 'Free',
        pro: 'Pro',
