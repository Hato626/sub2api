export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportWarning: 'Import will create new accounts/proxies and bind platform groups by default. Ensure existing data does not conflict.',
      dataImportSourceFile: 'File',
      dataImportSourceText: 'Paste JSON',
      dataImportFile: 'Data file',
      dataImportText: 'JSON text',
      dataImportTextPlaceholder: 'Paste exported account JSON here...',
      dataImportTextHint: 'Paste the complete exported JSON from your clipboard. Uses the same format as file import.',
      dataImportTextRequired: 'Please paste JSON data to import',
      dataImportPasteFromClipboard: 'Paste from clipboard',
      dataImportClipboardReadFailed: 'Unable to read clipboard. Paste manually instead.',
      ...
      openaiQuotaReset: {
        ...
        inviteTooltipLoad: 'Send a Codex earned-reset invite',
        inviteTooltipReady: 'Send an invite; account-pool targets are redeemed automatically when possible',
        inviteTooltipWithCount: '{count} invite(s) remaining',
        inviteTitle: 'Codex earned-reset invite',
        inviteModePool: 'Account Pool',
        ...
        inviteSuccess: 'Invite sent to {emails}',
        autoRedeemVerified: 'Auto redeem verified; target reset-credit count increased',
        autoRedeemAttempted: 'Auto redeem attempted: {reason}',
        autoRedeemFailed: 'Auto redeem failed: {reason}',
        autoRedeemSkipped: 'Auto redeem skipped: {reason}'
      },
      tier: {
        free: 'Free',
        pro: 'Pro',
